...
async function getcat(){
    ...
    var wallet = new ethers.Wallet("private key of contract deployer",provider);
    ...
    let signo=web3.eth.accounts.sign(msg,"private key of contract deployer");
    console.log(signo);
    alert(price);
